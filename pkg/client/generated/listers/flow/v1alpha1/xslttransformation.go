...
type XSLTTransformationLister interface {
	...
	List(selector labels.Selector) (ret []*flowv1alpha1.XSLTTransformation, err error)
...
type xSLTTransformationLister struct {
	listers.ResourceIndexer[*flowv1alpha1.XSLTTransformation]
}
...
func NewXSLTTransformationLister(indexer cache.Indexer) XSLTTransformationLister {
	return &xSLTTransformationLister{listers.New[*flowv1alpha1.XSLTTransformation](indexer, flowv1alpha1.Resource("xslttransformation"))}
}

// XSLTTransformations returns an object that can list and get XSLTTransformations.
func (s *xSLTTransformationLister) XSLTTransformations(namespace string) XSLTTransformationNamespaceLister {
	return xSLTTransformationNamespaceLister{listers.NewNamespaced[*flowv1alpha1.XSLTTransformation](s.ResourceIndexer, namespace)}
}
...
type XSLTTransformationNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*flowv1alpha1.XSLTTransformation, error)
