...
var kafkasourcesResource = v1alpha1.SchemeGroupVersion.WithResource("kafkasources")

var kafkasourcesKind = v1alpha1.SchemeGroupVersion.WithKind("KafkaSource")
...
func (c *FakeKafkaSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KafkaSource, err error) {
	emptyResult := &v1alpha1.KafkaSource{}
	obj, err := c.Fake.
...
func (c *FakeKafkaSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KafkaSourceList, err error) {
	emptyResult := &v1alpha1.KafkaSourceList{}
	obj, err := c.Fake.
...
func (c *FakeKafkaSources) UpdateStatus(ctx context.Context, kafkaSource *v1alpha1.KafkaSource, opts v1.UpdateOptions) (result *v1alpha1.KafkaSource, err error) {
	emptyResult := &v1alpha1.KafkaSource{}
	obj, err := c.Fake.
