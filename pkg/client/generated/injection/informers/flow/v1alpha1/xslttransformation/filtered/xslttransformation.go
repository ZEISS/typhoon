...
func Get(ctx context.Context, selector string) v1alpha1.XSLTTransformationInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/zeiss/typhoon/pkg/client/generated/listers/externalversions/flow/v1alpha1.XSLTTransformationInformer with selector %s from context.", selector)
	}
