...
func Get(ctx context.Context, selector string) v1alpha1.FunctionInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/zeiss/typhoon/pkg/client/generated/listers/externalversions/extensions/v1alpha1.FunctionInformer with selector %s from context.", selector)
	}
