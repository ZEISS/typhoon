...
func Get(ctx context.Context, selector string) v1alpha1.SalesforceTargetInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/zeiss/typhoon/pkg/client/generated/listers/externalversions/targets/v1alpha1.SalesforceTargetInformer with selector %s from context.", selector)
	}
