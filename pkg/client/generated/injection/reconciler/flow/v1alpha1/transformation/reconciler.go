...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Transformation, desired *v1alpha1.Transformation) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Transformation, desiredFinalizers sets.Set[string]) (*v1alpha1.Transformation, error) {
	// Don't modify the informers copy.
