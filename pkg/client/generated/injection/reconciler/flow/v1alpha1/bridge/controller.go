...
const (
	defaultControllerAgentName = "bridge-controller"
	defaultFinalizerName       = "bridges.flow.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	bridgeInformer := bridge.Get(ctx)

	lister := bridgeInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.typhoon.zeiss.com.Bridge"),
	)
