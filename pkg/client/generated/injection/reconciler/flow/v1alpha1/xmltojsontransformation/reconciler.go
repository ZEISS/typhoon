...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.XMLToJSONTransformation, desired *v1alpha1.XMLToJSONTransformation) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.XMLToJSONTransformation, desiredFinalizers sets.Set[string]) (*v1alpha1.XMLToJSONTransformation, error) {
	// Don't modify the informers copy.
