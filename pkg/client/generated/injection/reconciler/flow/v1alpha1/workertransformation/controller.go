...
import (
	...
	internalclientsetscheme "github.com/zeiss/typhoon/pkg/client/generated/clientset/internalclientset/scheme"
...
const (
	defaultControllerAgentName = "workertransformation-controller"
	defaultFinalizerName       = "workertransformations.flow.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	workertransformationInformer := workertransformation.Get(ctx)

	lister := workertransformationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.typhoon.zeiss.com.WorkerTransformation"),
	)
