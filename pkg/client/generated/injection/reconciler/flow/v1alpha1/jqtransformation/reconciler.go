...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.JQTransformation, desired *v1alpha1.JQTransformation) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.JQTransformation, desiredFinalizers sets.Set[string]) (*v1alpha1.JQTransformation, error) {
	// Don't modify the informers copy.
