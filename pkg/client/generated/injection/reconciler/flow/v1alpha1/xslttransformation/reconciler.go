...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.XSLTTransformation, desired *v1alpha1.XSLTTransformation) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.XSLTTransformation, desiredFinalizers sets.Set[string]) (*v1alpha1.XSLTTransformation, error) {
	// Don't modify the informers copy.
