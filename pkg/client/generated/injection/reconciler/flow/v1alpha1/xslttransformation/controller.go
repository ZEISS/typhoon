...
import (
	...
	xslttransformation "github.com/zeiss/typhoon/pkg/client/generated/injection/informers/flow/v1alpha1/xslttransformation"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "xslttransformations.flow.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "flow.typhoon.zeiss.com.XSLTTransformation"),
	)
