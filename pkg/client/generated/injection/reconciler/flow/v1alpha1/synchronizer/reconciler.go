...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Synchronizer, desired *v1alpha1.Synchronizer) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Synchronizer, desiredFinalizers sets.Set[string]) (*v1alpha1.Synchronizer, error) {
	// Don't modify the informers copy.
