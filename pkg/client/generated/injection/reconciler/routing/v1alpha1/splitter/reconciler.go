...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Splitter, desired *v1alpha1.Splitter) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Splitter, desiredFinalizers sets.Set[string]) (*v1alpha1.Splitter, error) {
	// Don't modify the informers copy.
