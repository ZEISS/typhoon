...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.CloudEventsTarget, desired *v1alpha1.CloudEventsTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.CloudEventsTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.CloudEventsTarget, error) {
	// Don't modify the informers copy.
