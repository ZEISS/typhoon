...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.DatadogTarget, desired *v1alpha1.DatadogTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.DatadogTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.DatadogTarget, error) {
	// Don't modify the informers copy.
