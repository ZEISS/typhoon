...
const (
	defaultControllerAgentName = "natstarget-controller"
	defaultFinalizerName       = "natstargets.targets.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	natstargetInformer := natstarget.Get(ctx)

	lister := natstargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.typhoon.zeiss.com.NatsTarget"),
	)
