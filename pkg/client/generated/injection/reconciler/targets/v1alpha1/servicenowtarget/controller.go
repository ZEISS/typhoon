...
const (
	defaultControllerAgentName = "servicenowtarget-controller"
	defaultFinalizerName       = "servicenowtargets.targets.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	servicenowtargetInformer := servicenowtarget.Get(ctx)

	lister := servicenowtargetInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "targets.typhoon.zeiss.com.ServiceNowTarget"),
	)
