...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.KafkaTarget, desired *v1alpha1.KafkaTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KafkaTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.KafkaTarget, error) {
	// Don't modify the informers copy.
