...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.OracleTarget, desired *v1alpha1.OracleTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.OracleTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.OracleTarget, error) {
	// Don't modify the informers copy.
