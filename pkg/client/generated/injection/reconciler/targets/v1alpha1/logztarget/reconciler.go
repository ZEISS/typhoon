...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.LogzTarget, desired *v1alpha1.LogzTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.LogzTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.LogzTarget, error) {
	// Don't modify the informers copy.
