...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.SplunkTarget, desired *v1alpha1.SplunkTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SplunkTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.SplunkTarget, error) {
	// Don't modify the informers copy.
