...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.LogzMetricsTarget, desired *v1alpha1.LogzMetricsTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.LogzMetricsTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.LogzMetricsTarget, error) {
	// Don't modify the informers copy.
