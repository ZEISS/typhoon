...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.JiraTarget, desired *v1alpha1.JiraTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.JiraTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.JiraTarget, error) {
	// Don't modify the informers copy.
