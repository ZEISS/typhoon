...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.SalesforceTarget, desired *v1alpha1.SalesforceTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SalesforceTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.SalesforceTarget, error) {
	// Don't modify the informers copy.
