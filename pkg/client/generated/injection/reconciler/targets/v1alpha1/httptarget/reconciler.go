...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.HTTPTarget, desired *v1alpha1.HTTPTarget) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.HTTPTarget, desiredFinalizers sets.Set[string]) (*v1alpha1.HTTPTarget, error) {
	// Don't modify the informers copy.
