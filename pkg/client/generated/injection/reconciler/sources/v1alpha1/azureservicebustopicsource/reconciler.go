...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.AzureServiceBusTopicSource, desired *v1alpha1.AzureServiceBusTopicSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureServiceBusTopicSource, desiredFinalizers sets.Set[string]) (*v1alpha1.AzureServiceBusTopicSource, error) {
	// Don't modify the informers copy.
