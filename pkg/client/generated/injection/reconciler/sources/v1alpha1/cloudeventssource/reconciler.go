...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.CloudEventsSource, desired *v1alpha1.CloudEventsSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.CloudEventsSource, desiredFinalizers sets.Set[string]) (*v1alpha1.CloudEventsSource, error) {
	// Don't modify the informers copy.
