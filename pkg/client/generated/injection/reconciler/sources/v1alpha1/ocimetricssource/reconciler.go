...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.OCIMetricsSource, desired *v1alpha1.OCIMetricsSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.OCIMetricsSource, desiredFinalizers sets.Set[string]) (*v1alpha1.OCIMetricsSource, error) {
	// Don't modify the informers copy.
