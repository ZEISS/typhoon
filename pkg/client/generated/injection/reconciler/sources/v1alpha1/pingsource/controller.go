...
import (
	...
	pingsource "github.com/zeiss/typhoon/pkg/client/generated/injection/informers/sources/v1alpha1/pingsource"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "pingsources.sources.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.typhoon.zeiss.com.PingSource"),
	)
