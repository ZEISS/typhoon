...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.AzureServiceBusSource, desired *v1alpha1.AzureServiceBusSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureServiceBusSource, desiredFinalizers sets.Set[string]) (*v1alpha1.AzureServiceBusSource, error) {
	// Don't modify the informers copy.
