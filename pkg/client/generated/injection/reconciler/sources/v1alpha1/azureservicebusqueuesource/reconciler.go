...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.AzureServiceBusQueueSource, desired *v1alpha1.AzureServiceBusQueueSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.AzureServiceBusQueueSource, desiredFinalizers sets.Set[string]) (*v1alpha1.AzureServiceBusQueueSource, error) {
	// Don't modify the informers copy.
