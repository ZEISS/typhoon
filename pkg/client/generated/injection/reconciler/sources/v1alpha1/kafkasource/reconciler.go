...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.KafkaSource, desired *v1alpha1.KafkaSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KafkaSource, desiredFinalizers sets.Set[string]) (*v1alpha1.KafkaSource, error) {
	// Don't modify the informers copy.
