...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.SalesforceSource, desired *v1alpha1.SalesforceSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SalesforceSource, desiredFinalizers sets.Set[string]) (*v1alpha1.SalesforceSource, error) {
	// Don't modify the informers copy.
