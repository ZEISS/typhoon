...
import (
	...
	eventingv1alpha1 "github.com/zeiss/typhoon/pkg/client/generated/listers/eventing/v1alpha1"
	zap "go.uber.org/zap"
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.RedisBroker, desiredFinalizers sets.Set[string]) (*v1alpha1.RedisBroker, error) {
	// Don't modify the informers copy.
