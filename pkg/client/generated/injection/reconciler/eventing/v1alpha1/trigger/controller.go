...
import (
	...
	trigger "github.com/zeiss/typhoon/pkg/client/generated/injection/informers/eventing/v1alpha1/trigger"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "triggers.eventing.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.typhoon.zeiss.com.Trigger"),
	)
