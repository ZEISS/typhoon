...
const (
	defaultControllerAgentName = "httpsink-controller"
	defaultFinalizerName       = "httpsinks.sinks.typhoon.zeiss.com"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	httpsinkInformer := httpsink.Get(ctx)

	lister := httpsinkInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sinks.typhoon.zeiss.com.HTTPSink"),
	)
