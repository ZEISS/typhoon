...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.Function, desired *v1alpha1.Function) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Function, desiredFinalizers sets.Set[string]) (*v1alpha1.Function, error) {
	// Don't modify the informers copy.
