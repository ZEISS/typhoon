...
import (
	...
	fake "github.com/zeiss/typhoon/pkg/client/generated/clientset/internalclientset/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/zeiss/typhoon/pkg/client/generated/clientset/internalclientset/fake.Clientset from context.")
	}
