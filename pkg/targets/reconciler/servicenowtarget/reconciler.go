...
type Reconciler struct {
	base       common.GenericServiceReconciler[*v1alpha1.ServiceNowTarget, listersv1alpha1.ServiceNowTargetNamespaceLister]
...
func (r *Reconciler) ReconcileKind(ctx context.Context, trg *v1alpha1.ServiceNowTarget) reconciler.Event {
