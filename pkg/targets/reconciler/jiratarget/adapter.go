...
const (
	envJiraBasicAuthUser  = "JIRA_BASIC_AUTH_USER"
	envJiraBasicAuthToken = "JIRA_BASIC_AUTH_TOKEN"
	envJiraURL            = "JIRA_URL"
)
...
type adapterConfig struct {
	...
	// Container image
	Image string `default:"ghcr.io/zeiss/typhoon/jiratarget-adapter"`
}
...
func MakeAppEnv(o *v1alpha1.JiraTarget) []corev1.EnvVar {
	return []corev1.EnvVar{
		{
			Name:  envJiraBasicAuthUser,
			Value: o.Spec.Auth.User,
		},
		{
			Name: envJiraBasicAuthToken,
