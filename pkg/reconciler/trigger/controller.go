...
import (
	...
	"github.com/zeiss/typhoon/pkg/apis/eventing"
	...
	tginformer "github.com/zeiss/typhoon/pkg/client/generated/injection/informers/eventing/v1alpha1/trigger"
	tgreconciler "github.com/zeiss/typhoon/pkg/client/generated/injection/reconciler/eventing/v1alpha1/trigger"
)
...
func NewController(
	...
	filterBroker := func(obj interface{}) bool {
		...
		rb := obj.(*eventingv1alpha1.RedisBroker)
