...
import (
	...
	eventingv1alpha1listers "github.com/zeiss/typhoon/pkg/client/generated/listers/eventing/v1alpha1"
...
func (r *secretReconciler) buildConfigSecret(ctx context.Context, rb eventingv1alpha1.ReconcilableBroker) (*corev1.Secret, error) {
	...
	return resource.NewSecret(ns, sn,
		resource.SecretWithMetaOptions(
			resource.MetaAddLabel(resource.AppNameLabel, AppAnnotationValue(rb)),
			resource.MetaAddLabel(resource.AppComponentLabel, "broker-config"),
		...
		resource.SecretSetData(ConfigSecretKey, b)), nil
}
