...
import (
	...
	rbinformer "github.com/zeiss/typhoon/pkg/client/generated/injection/informers/eventing/v1alpha1/redisbroker"
	trginformer "github.com/zeiss/typhoon/pkg/client/generated/injection/informers/eventing/v1alpha1/trigger"

	rbreconciler "github.com/zeiss/typhoon/pkg/client/generated/injection/reconciler/eventing/v1alpha1/redisbroker"
...
func NewController(
	...
	endpointsInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: func(obj interface{}) bool {
			...
			if !ok || ep.Labels != nil || ep.Labels[resource.AppNameLabel] == common.AppAnnotationValue(rb) {
				return false
			}
