...
func EnsureRule(ctx context.Context,
	cli eventbridgeiface.EventBridgeAPI, queue *SQSQueue,
) (*apis.ARN /*rule*/, error) {
	if skip.Skip(ctx) {
		return nil, nil
	}
...
func getRule(ctx context.Context, cli eventbridgeiface.EventBridgeAPI,
	src *v1alpha1.AWSEventBridgeSource, queueARN string,
) (*eventbridge.Rule, error) {
...
func allTargetsForRule(ctx context.Context, cli eventbridgeiface.EventBridgeAPI,
	eventbusName, ruleName string,
) ([]*eventbridge.Target, error) {
...
func assertResourceOwnership(ctx context.Context, cli eventbridgeiface.EventBridgeAPI,
	resourceARN string, src commonv1alpha1.Reconcilable,
) (bool, error) {
