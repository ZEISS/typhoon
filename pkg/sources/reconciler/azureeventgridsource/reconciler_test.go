...
func staticClientGetter(stCli eventgrid.SystemTopicsClient, prCli eventgrid.ProvidersClient,
	...
	ehCli eventgrid.EventHubsClient,
) eventgrid.ClientGetterFunc {
...
func (c *mockedSystemTopicsClient) ListBySubscriptionComplete(ctx context.Context,
	filter string, top *int32,
) (azureeventgrid.SystemTopicsListResultIterator, error) {
	c.calledList = true
...
func (c *mockedSystemTopicsClient) Delete(ctx context.Context,
	resourceGroupName, systemTopicName string,
) (azureeventgrid.SystemTopicsDeleteFuture, error) {
	c.calledDelete = true
...
) (azureeventgrid.EventSubscription, error) {
	c.calledGet = true
...
func (c *mockedEventSubscriptionsClient) ListBySystemTopic(ctx context.Context, resourceGroupName, systemTopicName,
	filter string, top *int32,
) (azureeventgrid.EventSubscriptionsListResultPage, error) {
	c.calledList = true
...
func (c *mockedEventSubscriptionsClient) Delete(ctx context.Context, resourceGroupName, systemTopicName,
	eventSubscriptionName string,
) (azureeventgrid.SystemTopicEventSubscriptionsDeleteFuture, error) {
	c.calledDelete = true
